...
import autseraImg from "../../assets/img/Autisma.png";
  ...
  return (
    ...
    >
      ...
      <div className="container-home">
        <img className="img-logo" src={autseraImg} alt="Autisma Logo" />
      ...
      <HelperAvatar
        speechText={<RouterLink to="/help" label="Hi, welcome to Autisma. Click here if you need help" />}
        timeOut={3600000}
      />
    </div>
  );
